...
# defined directories on the system. By default, the output file
# is saved in /tmp with a timestamped filename, compressed.
...
# change for your favorite compression app
compress="bzip2"
