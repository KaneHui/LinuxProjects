...
myhome="/home/kane/share/kuanghui/LinuxProjects/100-shell-script-examples/"
counter="$myhome/counter.dat"
lockfile="$myhome/counter.lck"
updatecounter="$myhome/updatecounter"

# Note that this script is not intended to be called directly from a web browser
# so it doesn't use the otherwise obligatory content-type header material
