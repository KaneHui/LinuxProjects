...
# expects DD and TD to be instantiated. instantiates nicenum if
# arg2 is specified, this function echoes output, rather than sending
...
nicenumber(){
    ...
    integer=$(echo $1 | cut -d. -f1)   # left of the dicimal point
    decimal=$(echo $1 | cut -d. -f2)   # right of the dicimal point
