...
# Suspenduser - suspend a user account for the indefinite future
...
if [ -z $1 ] ; then
    ...
    echo "Error. You must be 'root' to run something new." >&2
    exit 1
fi
...
If you have any questions, please contact Kane
******************************************************************

EOF
    echo "(Warned $1, now sleepng $secs seconds)"
    sleep $secs
