...
# accoutns are >=UID 100. Emails message to each violating user
# and reports a summary to the screen

MAXDISKUSAGE=20480
violators="/tmp/diskhogs$$"
...
Your disk usage is ${usage}MB but you have only been allocated ${MAXDISKUSAGE}MB.
This means that either you need to delete some of your files, compress your files
(see 'gzip' or 'bzip2' for powerful and easy-to-use compression programs), or talk
