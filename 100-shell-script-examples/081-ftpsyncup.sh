...
# all new or modified files are uploaded to the remote system. Uses a
# timestamp file ingeniously called. Timestamp to keep track.

timestamp=".timestamp"
tempfile="/tmp/ftpsyncup.$$"
count=0

trap "rm -f $tempfile" 0 1 15   # zap temfile on exit $sigs
