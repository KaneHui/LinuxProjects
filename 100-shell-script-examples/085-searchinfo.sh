...
# searchinfo - extract and analyze search engine traffic indicated in the referrer
# field of a Common Log Format access log.

host="baidu.com"    # change to your domain, as desired
maxmatches=20
count=0
temp="/tmp/$(basename $0).$$"
...
echo ""
echo Scanned $count entries in log file ouf $(wc -l < "$1") total.
